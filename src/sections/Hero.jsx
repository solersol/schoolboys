const Hero = () => {
  return (
    <section id="home" className="w-full h-screen flex flex-col justify-center items-center min-h-screen pb-[32rem] bg-cover bg-center">
      ...
      <h1 className="flex justify-center font-anton  text-[35px] mt-6 text-center px-4 break-words text-[#000] animate-slide-in-left">CA: COMING SOON  </h1>

      <a href="https://pump.fun/"><button className="animate-bounce mt-6 bg-[#2e1515] text-[#fff] rounded-full px-28 py-6 hover:bg-[#f0ff00] font-anton  text-[24px] ">
        BUY $SCHOOL
      </button></a>
